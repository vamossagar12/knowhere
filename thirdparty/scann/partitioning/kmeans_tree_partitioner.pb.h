...
class SerializedKMeansTreePartitioner :
 ...
 public:
  ...
  virtual ~SerializedKMeansTreePartitioner();
  ...
  inline SerializedKMeansTreePartitioner* New() const final {
    return CreateMaybeMessage<SerializedKMeansTreePartitioner>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_scann_2fpartitioning_2fkmeans_5ftree_5fpartitioner_2eproto);
    return ::descriptor_table_scann_2fpartitioning_2fkmeans_5ftree_5fpartitioner_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  ::research_scann::SerializedKMeansTree* release_kmeans_tree();
...
inline ::research_scann::SerializedKMeansTree* SerializedKMeansTreePartitioner::mutable_kmeans_tree() {
  ...
  if (kmeans_tree_ == nullptr) {
    auto* p = CreateMaybeMessage<::research_scann::SerializedKMeansTree>(GetArenaNoVirtual());
    kmeans_tree_ = p;
  }
